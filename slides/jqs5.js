...
function jqs5_init(){
	...
	$('body > h1').each(function(){$(this).add($(this).siblingsUntil('h2')).wrapAll(s); $(this).parent().addClass('first')});
	$('body > h2').each(function(){$(this).add($(this).siblingsUntil('h2')).wrapAll(s);});
